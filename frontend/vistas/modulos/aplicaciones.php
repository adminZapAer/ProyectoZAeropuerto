    ...
    <div class="container">
        ...
        <div class="row">
            ...
            *==   BREADCRUMBS O MIGAS DE PAN   ==*
            ...
            ========================================================*/
            if($rutas[0] == "aplicacion"){
                $item1 = null;
                $valor1 = null;
                $ordenar = "aplicacion";
                
            }
            $aplicaciones = ControladorProductos::ctrMostrarAplicaciones($ordenar, $item1, $valor1, $base, $tope, $modo);/*Mandamos a llamar*/
            
            $listaAplicaciones = ControladorProductos::ctrListarAplicaciones($ordenar, $item1, $valor1);
            ...
            <center>
                ...
                *==          PAGINACION            ==*
                ...
                if(count($listaAplicaciones) != 0){
                    ...
                    $pagAplicaciones = ceil(count($listaAplicaciones)/20); /**/
                    
                    if($pagAplicaciones > 4){
                        ...
                        if($rutas[1] == 1){
                            ...
                            echo '
                                ...
                                <li id = "item'.$pagAplicaciones.'"><a href="'.$url.$rutas[0].'/'.$pagAplicaciones.'">'.$pagAplicaciones.'</a></li>
                        ...
                        ======================================*/
                        else if ($rutas[1] == $pagAplicaciones)
                        {
                            echo '
                            <ul class="pagination">
                                <li><a href="'.$url.$rutas[0].'/'.($pagAplicaciones-1).'"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                                <li id="item1"><a href="'.$url.$rutas[0].'/1">1</a></li>
                                <li class = "disabled"><a>...</a></li>
                            ';
                            
                            for ($i = ($pagAplicaciones-3); $i <= $pagAplicaciones; $i++)
                            {
                                echo '<li id="item'.$i.'"><a href="'.$url.$rutas[0].'/'.$i.'">'.$i.'</a></li>';
                            }
                        ...
                        ======================================*/
                                ...
                                $rutas[1] != 1 &&
                                $rutas[1] < ($pagAplicaciones / 2) &&
                                $rutas[1] < ($pagAplicaciones - 3)
                               ){
