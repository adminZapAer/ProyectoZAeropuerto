...
if($titulosModulos[0] == "ARTÍCULOS GRATUITOS"){
    ...
    $ordenar = "idProducto";//esta variable va a ser la que defina como va a ser ordenada la tabla
    $item = "precio";
    $valor = 0;
    $modo = "DESC";
...
if($titulosModulos[0] == "LO MÁS VENDIDO"){
    ...
    $ordenar = "ventas";//esta variable va a ser la que defina como va a ser ordenada la tabla
    $item = null;
    $valor = null;
    $modo = "DESC";
...
if($titulosModulos[1] == "LO MÁS VISTO"){
    ...
    $ordenar = "vistas";//esta variable va a ser la que defina como va a ser ordenada la tabla
    $item = null;
    $valor = null;
    $modo = "DESC";
