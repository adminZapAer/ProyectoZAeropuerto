    ...
    <div class="container">
        ...
        <div class="row">
            ...
            *==   BREADCRUMBS O MIGAS DE PAN   ==*
            ...
            ========================================================*/
            if($rutas[0] == "tipo-de-sistema"){
                $item1 = null;
                $valor1 = null;
                $ordenar = "sistemas";
                
            }
            $sistemas = ControladorProductos::ctrMostrarSistemas($ordenar, $item1, $valor1, $base, $tope, $modo);/*Mandamos a llamar*/
            
            $listaSistemas = ControladorProductos::ctrListarSistemas($ordenar, $item1, $valor1);
            ...
            <center>
                ...
                *==          PAGINACION            ==*
                ...
                if(count($listaSistemas) != 0){
                    
                    $pagSistemas = ceil(count($listaSistemas)/20); /**/
                    ...
                    if($pagSistemas > 4){
                        ...
                        if($rutas[1] == 1){
                            ...
                            echo '
                                ...
                                <li id = "item'.$pagSistemas.'"><a href="'.$url.$rutas[0].'/'.$pagSistemas.'">'.$pagSistemas.'</a></li>
                        ...
                        ======================================*/
                        else if ($rutas[1] == $pagSistemas)
                        {
                            echo '
                            <ul class="pagination">
                                <li><a href="'.$url.$rutas[0].'/'.($pagSistemas-1).'"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                                <li id="item1"><a href="'.$url.$rutas[0].'/1">1</a></li>
                                <li class = "disabled"><a>...</a></li>
                            ';
                            
                            for ($i = ($pagSistemas-3); $i <= $pagSistemas; $i++)
                            {
                                echo '<li id="item'.$i.'"><a href="'.$url.$rutas[0].'/'.$i.'">'.$i.'</a></li>';
                            }
                        ...
                        ======================================*/
                                ...
                                $rutas[1] != 1 &&
                                $rutas[1] < ($pagSistemas / 2) &&
                                $rutas[1] < ($pagSistemas - 3)
                               ){
