    ...
    <div class="container">
        ...
        <div class="row">
            ...
            *==   BREADCRUMBS O MIGAS DE PAN   ==*
            ...
            $marcas = ControladorProductos::ctrMostrarMarcas($ordenar, $item1, $valor1, $base, $tope, $modo);/*Mandamos a llamar*/
            
            $listaMarcas = ControladorProductos::ctrListarMarcas($ordenar, $item1, $valor1);
            ...
            <center>
                ...
                *==          PAGINACION            ==*
                ...
                if(count($listaMarcas) != 0){
                    ...
                    $pagMarcas = ceil(count($listaMarcas)/20); /**/
                    ...
                    if($pagMarcas > 4){
                        ...
                        if($rutas[1] == 1){
                            ...
                            echo '
                                ...
                                <li id = "item'.$pagMarcas.'"><a href="'.$url.$rutas[0].'/'.$pagMarcas.'">'.$pagMarcas.'</a></li>
                        ...
                        ======================================*/
                        else if ($rutas[1] == $pagMarcas)
                        {
                            echo '
                            <ul class="pagination">
                                <li><a href="'.$url.$rutas[0].'/'.($pagMarcas-1).'"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                                <li id="item1"><a href="'.$url.$rutas[0].'/1">1</a></li>
                                <li class = "disabled"><a>...</a></li>
                            ';
                            
                            for ($i = ($pagMarcas-3); $i <= $pagMarcas; $i++)
                            {
                                echo '<li id="item'.$i.'"><a href="'.$url.$rutas[0].'/'.$i.'">'.$i.'</a></li>';
                            }
