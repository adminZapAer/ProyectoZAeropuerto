    ...
    <div class="container">
        ...
        <div class="row">
            ...
            *==   BREADCRUMBS O MIGAS DE PAN   ==*
            ...
            if($rutas[0] == "articulos-gratuitos"){
                $item1 = "precio";
                $valor1 = 0;
                $ordenar = "idProducto";
                ...
                /*Cuando esta el usuario entrando a la pagina de productos esta entrando a una url, la cual se va a mandar a la base de datos para que la busque y encuentre coincidencia con categoria, 
                si no le encuentra coincidencia con categoria, que busque el dato en subcategoria para que encuentre coincidencia con subcategoria.*/
                ...
                if(!$categoria){
                    ...
                    $item1 = "idSubcategoria";
                    $valor1 = $subCategoria[0]["idSubcategoria"];
                }
                else{
                    $item1 = "idCategoria";
                    $valor1 = $categoria["idCategoria"];
                }
            }
            
            $productos = ControladorProductos::ctrMostrarProductos($ordenar, $item1, $valor1, $base, $tope, $modo);/*Mandamos a llamar*/
            
            $listaProductos = ControladorProductos::ctrListarProductos($ordenar, $item1, $valor1);
